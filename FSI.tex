...
to extreme material properties and large interface deformation.  
...
\item steps 3 and 4 will induce a violation of mass, momentum, and energy
  conservation at the elastic fluid boundaries, but we have found the
