...
\begin{description}
\item[0.] Initially the fluid volume fractions tessellate the whole
  computational domain and the elastic materials tessellate the 
...
\item[10.] Elastic forces ($r=0$); see section \ref{elastic}.
  ...
  \frac{\vec{u}^{\ast\ast,k}-\vec{u}^{\ast,k,r}}{\Delta t}=
   F_{elastic}
  \end{eqnarray}
\item[11.] Pressure gradient; elastic materials clamped if $r=1$.  See 
